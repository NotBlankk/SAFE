...
def submit():
    ...
    if app_name.get()!="" and url.get()!="" and email_id.get()!="" and password.get()!="":
        ...
        #Into autohotkey
        a_file = open("Untitled.ahk", "r")
        lines = a_file.readlines()
        a_file.close()

        del lines[-1]

        new_file = open("Untitled.ahk", "w+")
        for line in lines:
            new_file.write(line)

        new_file.close()
        f = open("Untitled.ahk", "a")
        f.write("::")
        f.write(str(url.get()))
        f.write("::")
        f.write(str(password.get()))
        f.write("\n")
        f.write("return")
        f.close()
...
def update():
    ...
    if(t!=""):
        ...
        url_label_edit = Label(edit, text="Shortcut:")
...
url_label = Label(root, text = "Shortcut:")
